...
void loop(){
  if(estado == est_avanzar){
    ...
    else if(cn_izq >= 115 || cn_der >= 100){
      motor_izq.setSpeed(47);
      motor_der.setSpeed(47);
    }
    ...
    if(cn_ext_izq >= 45 ){
      ...
      motor_izq.setSpeed(42);
      motor_der.setSpeed(42);
    }
  }
  if(estado == int_der){
    ...
    motor_izq.setSpeed(0);
    motor_der.setSpeed(0);
    subest = subest_inter_der;
    if(subest == subest_inter_der){
      calibrar();
      if(cn_der < 80){
        motor_izq.setSpeed(-37);
        motor_der.setSpeed(37);
      }
      else if(cn_ext_izq >= 45){
        motor_izq.setSpeed(-37);
        motor_der.setSpeed(37);
        estado = est_avanzar;
      }
